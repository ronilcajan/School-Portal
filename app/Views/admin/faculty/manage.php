        ...
        <div class="col-md-12">
            ...
            <div class="white-box">
                <div class="button-box p-b-10" style="border-bottom:1px solid #e5ebec;">
                    <a href="<?= site_url('admin/create-faculty') ?>" class="btn btn-info waves-effect waves-light" data-toggle="modal">Create Faculty</a>
                </div>
               
                <h3 class="box-title m-b-0">Faculty Summary</h3>
                <div class="row m-0 m-b-20">
                    <div class="col-md-3 col-sm-6 info-box">
                        <div class="media">
                            <div class="media-body">
                                <h3 class="info-count text-blue"><?= count($faculty) ?></h3>
                                <p class="info-text font-12 text-primary">Total Faculty</p>
                    ...
                    <div class="col-md-3 col-sm-6 info-box">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <p class="info-text font-12 text-success">Active Faculty</p>
                                <span class="hr-line"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 info-box">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <p class="info-text font-12 text-danger">Inactive Faculty</p>
                                <span class="hr-line"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 info-box b-r-0">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <p class="info-text font-12">Facultys Created Today</p>
                                <span class="hr-line"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table id="myDatatables" class="display nowrap table-borderless" cellspacing="0" width="100%">
                        ...
                        <tbody>
                        <?php $no=1; foreach($faculty as $row): ?>
                            <tr>
                                <td><?= $no ?></td>
                                <td><a href="<?= site_url('admin/faculty/facultyInfo/'.$row['id']) ?>" ><?= ucwords($row['firstname'].' '.$row['lastname']) ?></a></td>
                                ...
                                <td>
                                    <a href="#" class="text-primary"><small>View</small></a> | 
                                    <a href="<?= site_url('admin/faculty/edit/'.$row['id']) ?>" class="text-info"><small>Edit</small></a> | 
                                    <a href="<?= site_url('admin/faculty/delete/'.$row['id']) ?>" class="text-danger"><small>Delete</small></a>
                                </td>
                            </tr>
                        <?php $no++; endforeach ?>
                        </tbody>
